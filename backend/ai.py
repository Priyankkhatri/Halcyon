...
NOTE ON FASTAPI: If the code returns a Python dictionary containing a datetime object, FastAPI will automatically serialize it safely. This is NOT a bug. Only standard json.dumps() fails on datetime.
